								...
								<FORM METHOD="post" ACTION="product.do" name="form1">
									<table class="table table-bordered" id="dataTable" width="100%"
										...
										<thead>
											...
											<jsp:useBean id="product_categorySvc" scope="page"
											...
											<tr>
												...
												<td><input type="TEXT" name="p_name" size="45"
													value="<%=productVO.getP_name()%>" /></td>
											</tr>
											<tr>
												<td>商品價格:</td>
												<td><input type="TEXT" name="p_price" size="45"
													value="<%=productVO.getP_price()%>" /></td>
											</tr>
											<tr>
												<td>商品詳情:</td>
												<td><input type="TEXT" name="p_detail" size="45"
													value="<%=productVO.getP_detail()%>" /></td>
											</tr>

											<tr>
												<td>商品狀態:</td>
												<td><lable> <input type="radio" name="p_status"
														value="0" checked>上架中</lable> <lable> <input
														type="radio" name="p_status" value="1">已下架</lable>
												<td>
											</tr>
											<tr>
												<td>上架時間:</td>
												<td><input type="DATE" name="p_upload_time"></td>
											</tr>
										</tbody>
									</table>
									<br> <input type="hidden" name="action" value="update">
									<input type="hidden" name="product_no"
										value="<%=productVO.getProduct_no()%>"> <input
					...
					<div class="modal-body">
						<FORM METHOD="post"
							...
							<table>
								...
								<tr>
									<td>新密碼:</td>
									<td><input type="password" name="w_npw" id="t_name"
										size=45 /></td>
								</tr>
							</table>
