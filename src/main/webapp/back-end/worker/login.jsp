...
<head>
  ...
  <title>Let's Work Out - Login</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block"><img src="<%=request.getContextPath() %>/back-end/worker/images/front.jpg" width=100% height="100%" border="0"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" ACTION="<%=request.getContextPath() %>/worker/worker.do" METHOD="post">
                    <div class="form-group">
                      <input type="account" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="w_acc" placeholder="帳號">
                    </div>
                    <div class="form-group">
