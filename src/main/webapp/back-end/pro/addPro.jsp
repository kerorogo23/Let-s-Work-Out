...
<table id="table-1">
	<tr><td>
		 <h3>教練資料新增 - addPro.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/back-end/pro/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<!-- 	</tr> -->
	...
	<tr>
		...
		<td><input type="TEXT" name="pro_resume" size="45"
			 value="<%= (proVO==null)? "跑步" : proVO.getProResume()%>" /></td>
	</tr>
	<tr>
		<td>經驗:</td>
		<td><input type="TEXT" name="expr" size="45"
			 value="<%= (proVO==null)? "體育老師" : proVO.getExpr()%>" /></td>
	</tr>
	<tr>
		<td>教練圖片:</td>
