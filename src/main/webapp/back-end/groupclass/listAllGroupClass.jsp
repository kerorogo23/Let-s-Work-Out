...
<%
    ...
    List<GroupClassVO> list = groupClassSvc.getAll();
...
<html>
<head>
<title>所有團體課程資料 - listAllGroupClass.jsp</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
        	<!-- Page Heading -->
          	<h1 class="h3 mb-4 text-gray-800">團課</h1>
          		<!-- DataTales Example -->
            	<div class="card shadow mb-4">
					<button type="button" data-toggle="modal" data-target="#add"><a href="addGroupClass.jsp">新增團課</a></button>
					<div class="card-body">
...
<!-- 									<th>刪除</th> -->
								...
								<c:forEach var="groupClassVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
									
									<tr ${(groupClassVO.groupClassNo==param.groupClassNo) ? 'bgcolor=#E8E8E8':''}>
...
<!-- 										</td> -->
										<td>
										  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/groupclass/groupClass.do" style="margin-bottom: 0px;">
										    ...
										    <input type="hidden" name="groupClassNo" value="${groupClassVO.groupClassNo}">
										    <input type="hidden" name="action" value="listGroupHours_ByGroupClassNo_A"></FORM>
										</td>
									</tr>
								</c:forEach>
							</table>
...
<%-- 		       <jsp:include page="listGroupHours_ByGroupClassNo.jsp" /> --%>
<%-- 		<% }%> --%>
</div>
